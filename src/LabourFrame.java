 ...
 * @author elify
 */
public class LabourFrame extends javax.swing.JFrame {

    /**
     * Creates new form LabourFrame
     */
    ...
    public LabourFrame() {
        ...
        setContentPane(ui);
        boxes = new JCheckBox[Labour.size()];
  ...
  votebutton.addActionListener(new ActionListener() {
   ...
   public void actionPerformed(java.awt.event.ActionEvent e) {
        ...
        try {
           FileWriter file = new FileWriter("Labourvote.txt",true);
            int counttik=0;
            for(int i = 0 ; i< Labour.size();i++){
 ...
 JPanel ui= new JPanel(new GridLayout(0,2));
    ...
    public void createrCheckBox(int i) {
        boxes[i] = new JCheckBox((String) Labour.get(i));
 ...
 public void WriteFile() throws IOException{
     ...
     int sz = Labour.size();
     for(int i=0 ; i<sz ; i++){
         output.write(Labour.get(i).toString()+"\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LabourFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
