 ...
 * @author elify
 */
public class NationalPeopleFrame extends javax.swing.JFrame {

    /**
     * Creates new form NationalPeopleFrame
     */
    PartySelection b = new PartySelection();

      ArrayList NationalPeople = b.getNationalPeople();
    public NationalPeopleFrame() {
        initComponents();
        b.NationalPeopleCandidates();
        ...
        setContentPane(ui);
        boxes = new JCheckBox[NationalPeople.size()];

        for (int i = 0; i < NationalPeople.size(); i++) {
            createrCheckBox(i);
        }
  ...
  votebutton.addActionListener(new ActionListener() {
   ...
   public void actionPerformed(java.awt.event.ActionEvent e) {
        ...
        try {
           FileWriter file = new FileWriter("NationalPeoplevote.txt",true);
         for(int i = 0 ; i< NationalPeople.size();i++){
        ...
        setTitle("National People Party");
        pack();
        setVisible(true);
        setResizable(true);
  ...
  public void WriteFile() throws IOException{
     ...
     try{
     FileWriter f = new FileWriter("NationalPeoplecand.txt",true);
     Writer  output = new BufferedWriter(f);
     int sz = NationalPeople.size();
     for(int i=0 ; i<sz ; i++){
         output.write(NationalPeople.get(i).toString()+"\n");
 ...
 JPanel ui= new JPanel(new GridLayout(0,2));
    ...
    public void createrCheckBox(int i) {
        boxes[i] = new JCheckBox((String) NationalPeople.get(i));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NationalPeopleFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        /* Create and display the form */
         Runnable r = () -> {
            JFrame frame = new NationalPeopleFrame();
        };
