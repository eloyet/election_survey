 ...
 * @author elify
 */
public class FreedomFrame extends javax.swing.JFrame {

    /**
     * Creates new form FreedomFrame
     */
    ...
    public FreedomFrame() {
       ...
       b.FreedomCandidates();
        ...
        ui.setBorder(new EmptyBorder(50,100,100,100));
        setContentPane(ui);
        boxes = new JCheckBox[Freedom.size()];

        for (int i = 0; i < Freedom.size(); i++) {
            createrCheckBox(i);
        }
        JButton votebutton=new JButton("VOTE");  
        votebutton.setBounds(0,0,0,0);  
        ui.add(votebutton);  
  votebutton.addActionListener(new ActionListener() {
   ...
   public void actionPerformed(java.awt.event.ActionEvent e) {
        ...
        try {
           FileWriter file = new FileWriter("Freedomvote.txt",true);
         for(int i = 0 ; i< Freedom.size();i++){
 ...
 public void WriteFile() throws IOException{
     ...
     try{
     FileWriter f = new FileWriter("Freedomcand.txt",true);
     Writer  output = new BufferedWriter(f);
     int sz = Freedom.size();
     for(int i=0 ; i<sz ; i++){
         output.write(Freedom.get(i).toString()+"\n");
 ...
 JPanel ui= new JPanel(new GridLayout(0,2));
    ...
    public void createrCheckBox(int i) {
        boxes[i] = new JCheckBox((String) Freedom.get(i));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FreedomFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
