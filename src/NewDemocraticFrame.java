 ...
 * @author elify
 */
public class NewDemocraticFrame extends javax.swing.JFrame {

    /**
     * Creates new form NewDemocraticFrame
     */
       PartySelection b = new PartySelection();

        ArrayList NewDemocratic = b.getNewDemocratic();
    public NewDemocraticFrame() {
        initComponents();
        b.NewDemocraticCandidates();
        ...
        setContentPane(ui);
        boxes = new JCheckBox[NewDemocratic.size()];

        for (int i = 0; i < NewDemocratic.size(); i++) {
            createrCheckBox(i);
        }
  ...
  votebutton.addActionListener(new ActionListener() {
   ...
   public void actionPerformed(java.awt.event.ActionEvent e) {
        ...
        try {
           FileWriter file = new FileWriter("NewDemocraticvote.txt",true);
           for(int i = 0 ; i< NewDemocratic.size();i++){
 ...
 public void WriteFile() throws IOException{
     ...
     try{
     FileWriter f = new FileWriter("NewDemocraticcand.txt",true);
     Writer  output = new BufferedWriter(f);
     int sz = NewDemocratic.size();
     for(int i=0 ; i<sz ; i++){
         output.write(NewDemocratic.get(i).toString()+"\n");
 ...
 JPanel ui= new JPanel(new GridLayout(0,2));
    ...
    public void createrCheckBox(int i) {
        boxes[i] = new JCheckBox((String) NewDemocratic.get(i));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewDemocraticFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
       ...
       Runnable r = () -> {
            JFrame frame = new NewDemocraticFrame();
        };
